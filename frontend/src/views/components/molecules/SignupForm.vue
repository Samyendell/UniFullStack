<template>
    <div class="form-container">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input 
              ...
              :class="{ 'error': submitted && !formData.firstName }"
            />
            <div v-show="submitted && !formData.firstName" class="validation-error">
          ...
          <div class="form-group">
            ...
            <input 
              ...
              :class="{ 'error': submitted && !formData.lastName }"
            />
            <div v-show="submitted && !formData.lastName" class="validation-error">
      ...
      <p class="switch-form">
        ...
        <a href="#" @click="$emit('switch-mode')">Sign In</a>
      </p>
    </div>
  </template>
